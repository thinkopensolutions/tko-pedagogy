...
class pedagogy_base_school_year_wizard(osv.osv):
    _name = 'pedagogy_base_school_year_wizard'
    # _inherit = 'res.partner'
    _description = _('pedagogy_base_school_year_wizard Module')
    ...
    def action_done(self, cr, uid, ids, context={}):
        ...
        wf_service.trg_validate(uid, 'pedagogy_base_school_year_wizard', obj.id, 'sign_done', cr)
        return True
    ...
    def action_cancel(self, cr, uid, ids, context={}):
        ...
        obj = self.browse(cr, uid, ids[0], context)
        wf_service = netsvc.LocalService("workflow")
        wf_service.trg_validate(uid, 'pedagogy_base_school_year_wizard', obj.id, 'sign_cancel', cr)
        return True
